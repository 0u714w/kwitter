...
const api = "https://intense-dusk-76045.herokuapp.com";
...
export const register = registerData => dispatch => {
  ...
  fetch("https://intense-dusk-76045.herokuapp.com/auth/register", {
    method: "POST",
    headers: {
...
export const addTweet = ({ message }) => (dispatch, getState) => {
  axios({
    method: "POST",
    url: "https://intense-dusk-76045.herokuapp.com/messages",
    headers: {
...
export function getMessages() {
  return function(dispatch) {
    axios
      .get("https://intense-dusk-76045.herokuapp.com/messages?limit=1000&offset=0")
      .then(res => {
